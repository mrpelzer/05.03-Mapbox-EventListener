# 📍 Map Click Counter Project

## Objective
In this project, you will build a simple interactive feature that tracks how many times a user clicks on a map. Each click should increment a counter, and the updated count should be displayed in an input box.
